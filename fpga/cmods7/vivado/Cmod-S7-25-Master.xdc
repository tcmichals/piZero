...
## RGB LEDs
set_property -dict { PACKAGE_PIN F1    IOSTANDARD LVCMOS33 } [get_ports { o_rgb_b_0 }]; #IO_L10N_T1_34 Sch=led0_b
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { o_rgb_g_0 }]; #IO_L9N_T1_DQS_34 Sch=led0_g
set_property -dict { PACKAGE_PIN F2    IOSTANDARD LVCMOS33 } [get_ports { o_rgb_r_0 }]; #IO_L10P_T1_34 Sch=led0_r

## 4 LEDs
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { led_0_0 }]; #IO_L8P_T1_34 Sch=led[1]
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { led_1_0 }]; #IO_L16P_T2_34 Sch=led[2]
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { led_2_0 }]; #IO_L16N_T2_34 Sch=led[3]
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { led_3_0 }]; #IO_L8N_T1_34 Sch=led[4]
...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { i_SPI_MOSI_0 }]; #IO_L18N_T2_34 Sch=pio[01]
set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { o_SPI_MISO_0 }]; #IO_L19P_T3_34 Sch=pio[02]
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { i_SPI_Clk_0 }]; #IO_L19N_T3_VREF_34 Sch=pio[03]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { i_SPI_CS_n_0 }]; #IO_L20P_T3_34 Sch=pio[04]
